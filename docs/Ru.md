...
<img src="../imgs/priview.jpg" alt="Симуляция проекта" width="900">
...
В рамках этой работы осуществляется разработка Docker контейнера, который служит для стандартизации и воспроизводимости среды разработки и тестирования. Также производится создание URDF модели робота, которая подробно описывает все механические и визуальные аспекты робота. Разрабатываются файлы конфигурации, необходимые для управления поведением модели робота в Gazebo, а также файлы запуска, которые настраивают параметры и зависимости для инициализации симуляции и визуализации в ROS и Gazebo. Кроме того, формируется настраиваемый мир в Gazebo, предоставляющий тестовую среду для робота, и проводится настройка PID контроллеров для оптимизации управления движением робота.
...
<img src="../imgs/result_mobile_platform.gif" alt="Результат" width="600">
...
[Исходный код common_macro.xacro:]()
...
[Исходный код control_block.xacro:]()
...
<img src="../imgs/rviz_window.jpg" alt="Модель мобильного робота в rviz" height="600">
...
[Исходный код simple_controller.cpp]()
...
<img src="../imgs/gui_window.jpg" alt="Модель мобильного робота в rviz" height="400">
...
Давайте приступим к разраотке ноды управленяи камерой. Нода предназначена для приема изображений с камеры робота, обработки полученных данных и их визуализации, а также последующей публикации обработанных изображений.
...
<img src="../imgs/camera_window.jpg" alt="Модель мобильного робота в rviz" height="600">
...
[Исходный код map_ground.material]()
...
[Исходный код robot_base.launch]()
...
Для более полного описания секции о симуляции в Gazebo и RViz вашего отчёта, вы можете дополнить текст следующим образом:
...
<img src="../imgs/rosgraph.png" alt="Привью RQT Graph">
...
<img src="../imgs/result_mobile_platform.gif" alt="Симуляция проекта" width="900">
...
1. **Разработка надежной URDF модели робота,** которая описывает физическую структуру и визуальные аспекты, включая динамические и кинематические параметры.
